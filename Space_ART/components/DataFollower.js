    ...
    return (
            <div>
                <p  onClick={() => this.setState({modal_follower:!this.state.modal_follower})} 
                    style={{fontSize:'50%'}}>
                        Followers : {this.state.number_follower}
                </p>
                {
            this.state.modal_follower ? <section>
              ...
              <div>
                  ...
                  <button className="button is-dark is-outlined button-center" onClick={() => this.setState({modal_follower:!this.state.modal_follower})}>Close</button>
