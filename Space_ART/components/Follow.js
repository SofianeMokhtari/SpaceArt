        ...
        <div>
            {
                ...
                <button className="button is-success is-outlined" onClick={() => this.addFollow(this.props.id)} style={{marginTop:'5%'}}><FontAwesomeIcon icon='heart' style={{marginRight:'7.5%'}}/>Follow</button>
                : this.state.follow == true && this.checkId() == 0 ?
                <button className="button is-success" onClick={() => this.stopFollow(this.props.id)} style={{marginTop:'5%'}}><FontAwesomeIcon icon='heart-broken' style={{marginRight:'7.5%'}}/>Unfollow</button>
                : null
            }
          </div>
    )
